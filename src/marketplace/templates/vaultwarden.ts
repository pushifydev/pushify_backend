...
- **Lightweight** — runs on as little as 64MB RAM`,
  ...
  envVars: [
    ...
    {
      key: 'I_REALLY_WANT_VOLATILE_STORAGE',
      label: 'Allow Volatile Storage',
      description: 'Internal flag — Pushify mounts a persistent volume but Vaultwarden requires this acknowledgement',
      required: false,
      type: 'text',
      default: 'true',
      hidden: true,
