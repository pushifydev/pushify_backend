...
export const tr: TranslationKeys = {
  ...
  databases: {
    ...
    // Veri gezgini (studio)
    studioUnsupportedEngine: 'Veri gezgini yalnızca PostgreSQL ve MySQL veritabanlarında kullanılabilir',
    studioTableNotFound: 'Tablo bulunamadı',
    studioInvalidIdentifier: 'Bilinmeyen tablo veya sütun',
    studioInvalidValue: 'Desteklenmeyen değer tipi',
    studioInvalidFilter: 'Geçersiz filtre',
    studioNoPrimaryKey: 'Bu tabloda birincil anahtar yok, bu yüzden satırları düzenlenemez',
    studioPrimaryKeyRequired: 'Satırın birincil anahtarı gerekli',
    studioNoValues: 'Herhangi bir değer verilmedi',
    studioViewReadOnly: 'Görünümler salt okunurdur',
    studioTooManyRows: 'Tek istekte çok fazla satır',
    studioEmptyQuery: 'Sorgu boş',
    studioQueryTooLong: 'Sorgu çok uzun',
    studioQueryFailed: 'Sorgu çalıştırılamadı',
    studioReadOnlyBlocked: 'Salt okunur mod tek bir SELECT ifadesine izin verir. Bunu çalıştırmak için yazma modunu açın.',
    studioRowInserted: 'Satır eklendi',
    studioRowUpdated: 'Satır güncellendi',
    studioRowsDeleted: 'Satırlar silindi',
    studioInvalidColumnType: 'Desteklenmeyen sütun tipi',
    studioAutoIncrementType: 'Bu tip otomatik artan olamaz',
    studioAutoIncrementKey: 'Otomatik artan sütun birincil anahtar olmalı',
    studioNoColumns: 'En az bir sütun ekleyin',
    studioTooManyColumns: 'Çok fazla sütun',
    studioDuplicateColumn: 'Bu adda bir sütun zaten var',
    studioLastColumn: 'Tabloda en az bir sütun kalmalı',
    ...
    studioIndexNotFound: 'İndeks bulunamadı',
    studioPrimaryIndex: 'Birincil anahtar indeksi silinemez',
    studioInvalidIndexMethod: 'Desteklenmeyen indeks yöntemi',
    ...
    studioNoAccess: 'Bu veritabanının veri gezginine erişiminiz yok',
    studioReadOnlyAccess: 'Veri gezgini erişiminiz salt okunur',
    studioSlowQueriesUnavailable: 'Bu veritabanında sorgu istatistikleri açık değil (pg_stat_statements / performance_schema)',
  },
};
