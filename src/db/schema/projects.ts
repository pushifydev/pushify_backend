...
export const domains = pgTable('domains', {
  ...
  /** production | staging — which copy of the project this domain points at */
  ...
  // What the domain serves right now (daily check, services/cert-expiry.service.ts)
  sslExpiresAt: timestamp('ssl_expires_at', { withTimezone: true }),
  sslExpiryNotifiedAt: timestamp('ssl_expiry_notified_at', { withTimezone: true }),
