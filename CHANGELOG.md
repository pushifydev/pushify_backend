...
### Fixed
- **Deploy log says where a domain points.** "ahuandco.com does not point to this server yet (A record → 167.233.197.118)" read as if that IP were the current record; it now says "ahuandco.com points to 91.195.240.94, not this server — set its A record to 167.233.197.118 at your DNS provider".
